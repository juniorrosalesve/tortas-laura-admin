                ...
                <div class="p-6 space-y-6">
                    ...
                    <form action="{{ route('store-materia-prima') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="number" value="0" min="1" step="0.001" name="cantidad" id="cantidad" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
